...
You can use the `data-date-override` attribute in the script tag to force a partiular date. i.e. `data-date-override="2026-04-05 23:59:59"`

The content of the `weeks` array is copy-pasted from the `JSON` column of [this](https://docs.google.com/spreadsheets/d/14dEyCiJLnSbGRUNoK2uWUiyQ5M8bKfT064onQvh1Aj4/edit?usp=sharing) Google Sheet. Repeat this copying process to bring in fresh data.
